    ...
    <div className="container">
      <nav className="navbar navbar-light bg-light">
        <div className="container-fluid">
          <a className="navbar-brand" href="index.html">
            <img src="images/lax.png" alt="" width="40" height="34" className="d-inline-block align-text-top"/>
            Horizon Offices
          </a>
        </div>
      </nav>
      ...
      <div id="carouselExampleControls" className="carousel slide" data-bs-ride="carousel">
        <div className="carousel-inner">
          ...
          <div className="carousel-item">
            <img src="images/brydon-mccluskey-GvPceVqbxm4-unsplash.jpg" class="d-block w-100 h-50" alt="..."/>
          </div>
        </div>
      ...
      <div className="container building-types">
        <div className="row">
            <div className="col-md-3">
                ...
                <img src="images/skyscrapers.jpg" className="stars" alt="5Star"/>
